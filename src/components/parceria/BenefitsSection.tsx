...
const BenefitsSection = () => {
  const benefits = [
    {
      icon: (
        <Clock className="w-12 h-12 text-medical-green group-hover:text-sky-600 transition-colors duration-300" />
      ),
      title: "Resultados em Tempo Recorde",
      description:
        "Laudos entregues em até 24 horas, integrados diretamente à sua plataforma.",
    },
    {
      icon: (
        <div className="w-12 h-12 bg-medical-green group-hover:bg-sky-600 transition-colors duration-300 rounded-lg flex items-center justify-center">
          <span className="text-white font-bold">24/7</span>
        </div>
      ),
      title: "Acesso 24/7 à Área do Dentista",
      description:
        "Baixe imagens DICOM, históricos de exames e laudos assinados por especialistas.",
    },
    {
      icon: (
        <Shield className="w-12 h-12 text-medical-green group-hover:text-sky-600 transition-colors duration-300" />
      ),
      title: "Suporte Técnico Especializado",
      description:
        "Nossa equipe resolve dúvidas complexas e oferece consultoria para casos desafiadores.",
    },
    {
      icon: (
        <div className="w-12 h-12 bg-medical-green group-hover:bg-sky-600 transition-colors duration-300 rounded-lg flex items-center justify-center">
      ...
      description:
        "Trabalhamos com os principais planos odontológicos, reduzindo burocracias.",
    },
  ];
