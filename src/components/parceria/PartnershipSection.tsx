  ...
  const reasons = [
    {
      ...
      description: "Equipamentos certificados pela ANVISA e laudos validados por especialistas com mais de 15 anos de experiência."
    },
    {
      icon: <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4">
        <Clock className="w-8 h-8 text-digital-blue" />
      </div>,
      title: "Agilidade sem Igual",
      description: "Agendamentos online em minutos, entregas rápidas e plataforma intuitiva para gestão de exames."
    },
    {
      icon: <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4">
      ...
      description: "Oferecemos treinamentos exclusivos para sua equipe e materiais de apoio técnico para melhorar seus diagnósticos."
    }
  ];

  return (
    <section id="parceria" className="py-20 bg-digital-blue relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="font-montserrat font-bold text-4xl md:text-5xl text-white mb-6">
            Por Que Ser
            <span className="text-medical-green"> Parceiro Digital X?</span>
          </h2>
